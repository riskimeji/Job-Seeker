        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">10 Firts Users</h4>
                    {{-- <div class="flex-shrink-0">
                        <div class="dropdown">
                    ...
                    <table class="table align-middle table-nowrap ">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./assets/images/product/img-4.png') }}" class="img-fluid"
                                            alt="">
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./assets/images/product/img-5.png') }}" class="img-fluid"
                                            alt="">
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 50px;">
                                    <div class="avatar-md me-4">
                                        <img src="{{ URL::asset('./assets/images/product/img-6.png') }}" class="img-fluid"
                                            alt="">
                                    </div>
                                </td>
