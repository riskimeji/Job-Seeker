                    ...
                    <div id="basic-pills-wizard" class="twitter-bs-wizard">
                        ...
                        <div class="tab-content twitter-bs-wizard-tab-content">
                            <div class="tab-pane" id="personal-information">
                                ...
                                <form method="POST" action="{{ asset('dashboard/company-compleate') }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="phone_perusahaan"
                                                    ...
                                                    value="{{ old('phone_perusahaan') }}" id="basicpill-lastname-input"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="basicpill-address-input" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                                    value="{{ old('alamat') }}" rows="2" placeholder="Enter Detail Your Address" required></textarea>
                                                @error('alamat')
                                                    {{ $message }}
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="google_maps" value="{{ old('google_maps') }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" id="datepicker-timepicker"
                                                    ...
                                                    name="jam_kerja_mulai" value="08:00" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="time"
                                                    ...
                                                    id="datepicker-humanfd" name="jam_kerja_berakhir" value="16:00"
                                                    required>
