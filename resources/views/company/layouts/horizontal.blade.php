    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ url('dashboard/company/profile') }} "><i
                ...
                <ul class="navbar-nav">
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        ...
                                                        <a href="ui-placeholders " class="dropdown-item"
                                                            data-key="t-progress-bars">@lang('translation.Placeholders')</a>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <a href="extended-sweet-alert " class="dropdown-item"
                                                    data-key="t-sweet-alert">@lang('translation.Sweet_Alert') 2</a>
                                                <a href="extended-session-timeout " class="dropdown-item"
                                                    data-key="t-session-timeout">@lang('translation.Session_Timeout')</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages"
                            role="button">
                            <i data-feather="grid"></i><span data-key="t-apps">@lang('translation.Apps')</span>
                            <div class="arrow-down"></div>
                        </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                    ...
                                    <a href="ecommerce-product-detail " class="dropdown-item"
                                        data-key="t-product-detail">@lang('translation.Product_Detail')</a>
                                    ...
                                    <a href="ecommerce-cart " class="dropdown-item"
                                        data-key="t-cart">@lang('translation.Cart')</a>
                                    ...
                                    <a href="ecommerce-shops " class="dropdown-item"
                                        data-key="t-shops">@lang('translation.Shops')</a>
                                    <a href="ecommerce-add-product " class="dropdown-item"
                                        data-key="t-add-product">@lang('translation.Add_Product')</a>
                                </div>
                            </div>


                            <a href="apps-calendar " class="dropdown-item"
                                data-key="t-calendar">@lang('translation.Calendars')</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-tasks">
                                    <a href="tasks-list " class="dropdown-item"
                                        data-key="t-task-list">@lang('translation.Task_List')</a>
                                    <a href="tasks-kanban " class="dropdown-item"
                                        data-key="t-kanban-board">@lang('translation.Kanban_Board')</a>
                                    <a href="tasks-create " class="dropdown-item"
                                        data-key="t-create-task">@lang('translation.Create_Task')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    ...
                                    <a href="{{ url('dashboard/company/profile') }} " class="dropdown-item"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components"
                            role="button">
                            <i data-feather="box"></i><span data-key="t-components">@lang('translation.Components')</span>
                            <div class="arrow-down"></div>
                        </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="form-elements " class="dropdown-item"
                                        data-key="t-form-elements">@lang('translation.Basic_Elements')</a>
                                    <a href="form-validation " class="dropdown-item"
                                        data-key="t-form-validation">@lang('translation.Validation')</a>
                                    <a href="form-advanced " class="dropdown-item"
                                        data-key="t-form-advanced">@lang('translation.Advanced_Plugins')</a>
                                    <a href="form-editors " class="dropdown-item"
                                        data-key="t-form-editors">@lang('translation.Editors')</a>
                                    <a href="form-uploads " class="dropdown-item"
                                        data-key="t-form-upload">@lang('translation.File_Upload')</a>
                                    <a href="form-wizard " class="dropdown-item"
                                        data-key="t-form-wizard">@lang('translation.Wizard')</a>
                                    <a href="form-mask " class="dropdown-item"
                                        data-key="t-form-mask">@lang('translation.Mask')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    <a href="tables-basic " class="dropdown-item"
                                        data-key="t-basic-tables">@lang('translation.Bootstrap_Basic')</a>
                                    <a href="tables-datatable " class="dropdown-item"
                                        data-key="t-data-tables">@lang('translation.Data_Tables')</a>
                                    <a href="tables-responsive " class="dropdown-item"
                                        data-key="t-responsive-table">@lang('translation.Responsive')</a>
                                    <a href="tables-editable " class="dropdown-item"
                                        data-key="t-editable-table">@lang('translation.Editable_Table')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    ...
                                    <a href="charts-echart " class="dropdown-item"
                                        data-key="t-e-charts">@lang('translation.E_Charts')</a>
                                    <a href="charts-chartjs " class="dropdown-item"
                                        data-key="t-chartjs-charts">@lang('translation.Chartjs')</a>
                                    <a href="charts-knob " class="dropdown-item"
                                        data-key="t-knob-charts">@lang('translation.Jquery_Knob')</a>
                                    <a href="charts-sparkline " class="dropdown-item"
                                        data-key="t-sparkline-charts">@lang('translation.Sparkline')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="icons-feather " class="dropdown-item"
                                        data-key="t-feather">@lang('translation.Feather')</a>
                                    <a href="icons-boxicons " class="dropdown-item"
                                        data-key="t-boxicons">@lang('translation.Boxicons')</a>
                                    ...
                                    <a href="icons-dripicons " class="dropdown-item"
                                        data-key="t-dripicons">@lang('translation.Dripicons')</a>
                                    <a href="icons-fontawesome " class="dropdown-item"
                                        data-key="t-font-awesome">@lang('translation.Font_awesome') 5</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-map">
                                    <a href="maps-google " class="dropdown-item"
                                        data-key="t-g-maps">@lang('translation.Google')</a>
                                    <a href="maps-vector " class="dropdown-item"
                                        data-key="t-v-maps">@lang('translation.Vector')</a>
                                    <a href="maps-leaflet " class="dropdown-item"
                                        data-key="t-l-maps">@lang('translation.Leaflet')</a>
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                    ...
                                    <a href="pages-pricing " class="dropdown-item"
                                        data-key="t-pricing">@lang('translation.Pricing')</a>
