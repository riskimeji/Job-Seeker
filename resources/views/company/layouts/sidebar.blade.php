    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ asset('dashboard/company') }}">
                ...
                <li>
                    <a href="{{ asset('dashboard/user') }}">
                        ...
                        <span data-key="t-chat">Karyawan</span>
                    </a>
                </li>
                <li>
                    <a href="apps-chat">
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="extended-session-timeout" data-key="t-session-timeout">@lang('translation.Session_Timeout')</a>
                        </li>
