...
@section('container')
    <div style="margin-top: 140px;">
        ...
        <h3 class="blue-style text-center mt-4">Masuk Sebagai Admin</h3>
        <div class="container mt-4" style="width: 500px;">
            <form>
                ...
                @endif
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label blue-style">Email</label><label
                        class="wajib">*</label>
                    <input type="email" class="form-control" style="border-radius: 0px;" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label blue-style">Kata Sandi</label><label
                        class="wajib">*</label>
            ...
            <label for="" class="mt-1">Belum Punya Akun? <a href="{{ asset('signup') }}">Daftar</a></label>
        </div>
    </div>
@endsection
