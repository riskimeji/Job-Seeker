                        ...
                        <div class="col-lg-5">
                            <div>
                                <h5 class="font-size-14 mb-4">Add
                                    data</h5>
                                <form method="POST" action="/dashboard/hari-kerja/{{ $harikerjas->id }}">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" value="{{ old('id', $harikerjas->id) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    id="formrow-password-input" value="{{ old('name', $harikerjas->name) }}"
