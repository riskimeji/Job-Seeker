            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Hari Kerja <span
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                ...
                                <div>
                                    <a href="{{ asset('dashboard/hari-kerja/create') }}" class="btn btn-light"><i
                            ...
                            <tbody>
                                @foreach ($harikerjas as $harikerja)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="text-body">{{ $harikerja->name }}</a>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                <button
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item"
                                                            href="/dashboard/hari-kerja/{{ $harikerja->id }}/edit">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form action="/dashboard/hari-kerja/{{ $harikerja->id }}"
