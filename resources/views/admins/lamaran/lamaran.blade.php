            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Data Lamaran <span
                                ...
                                @foreach ($lamarans as $lamaran)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="text-body">{{ $lamaran->user->first_name }}
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item"
                                                            href="/dashboard/lamaran/{{ $lamaran->id }}/edit">Edit</a>
                                                    </li> {{-- <li><a class="dropdown-item" href="#">Delete</a></li> --}}
                                                    <li>
                                                        <form action="/dashboard/lamaran/{{ $lamaran->id }}"
