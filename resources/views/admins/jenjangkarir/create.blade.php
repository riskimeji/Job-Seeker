                        ...
                        <div class="col-lg-5">
                            <div>
                                <h5 class="font-size-14 mb-4">Add
                                    data</h5>
                                <form method="POST" action="{{ asset('dashboard/jenjang-karir') }}">
                                    @csrf
                                    <div class="row">
                                        {{-- <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="formrow-email-input">Id</label>
                                                <input type="number" class="form-control" disabled placeholder=" Id">
                                            </div>
                                        </div> --}}
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    id="formrow-password-input" placeholder="Enter Industry Name" required>
                                                @error('name')
                                                    {{ $message }}
                                                @enderror
                                            </div>
