            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Jam Kerja <span
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                ...
                                <div>
                                    <a href="{{ asset('dashboard/jam-kerja/create') }}" class="btn btn-light"><i
                                ...
                                @foreach ($jamkerjas as $jamkerja)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="text-body">{{ $jamkerja->name }}</a>
                                        </td>
                                        {{-- <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item"
                                                            href="/dashboard/jam-kerja/{{ $jamkerja->id }}/edit">Edit</a>
                                                    </li>
                                                    {{-- <li><a class="dropdown-item" href="#">Delete</a></li> --}}
                                                    <li>
                                                        <form action="/dashboard/jam-kerja/{{ $jamkerja->id }}"
