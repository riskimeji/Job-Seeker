                        ...
                        <div class="col-lg-5">
                            <div>
                                <h5 class="font-size-14 mb-4">Add
                                    data</h5>
                                <form method="POST" action="/dashboard/jam-kerja/{{ $jamkerjas->id }}">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" value="{{ old('id', $jamkerjas->id) }}"
                                                    class="form-control" disabled placeholder=" Id">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="formrow-password-input">Jam Kerja</label>
                                                <input type="text" name="name"
                                                    class="form-control @error('name') is-invalid @enderror"
                                                    id="formrow-password-input" value="{{ old('name', $jamkerjas->name) }}"
