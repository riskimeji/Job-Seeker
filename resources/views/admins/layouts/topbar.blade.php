    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ asset('dashboard/admin') }}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="{{ asset('dashboard/admin') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="30">
                    </span>
                    <span class="logo-lg">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        ...
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>1 min ago</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item" href="auth-lock-screen"><i
                            class="mdi mdi-lock font-size-16 align-middle me-1"></i> @lang('translation.Lock_Screen')</a> --}}
