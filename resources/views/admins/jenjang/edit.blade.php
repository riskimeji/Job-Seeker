                        ...
                        <div class="col-lg-5">
                            <div>
                                <h5 class="font-size-14 mb-4">Edit
                                    data</h5>
                                <form method="POST" action="/dashboard/jenjang-pendidikan/{{ $jenjangs->id }}">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" disabled class="form-control" name="id"
                                                    value="{{ old('id', $jenjangs->id) }}" disabled placeholder="Id">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="{{ old('name', $jenjangs->name) }}" id="formrow-password-input"
                                                    placeholder="Enter Masukan Nama Jenjang">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-2">
